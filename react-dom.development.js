...
(function (global, factory) {
  ...
  var setAttributeCanStringify = undefined;
  /**
   * Detects an IE8/jsdom limitation i.e. not stringifying the value passed to
   * setAttribute.
   * Stringification was added in
   * https://github.com/facebook/react/commit/b0455f46709fca94da0b6126b719d6dd07605e65 for jsdom.
   * Later on the comment about IE8/9 was added in https://github.com/facebook/react/commit/3b94abcb3b2c05fc38406b02a501427e58377c44
   * This seems to be fixed in IE9 already, as suggested by https://github.com/facebook/react/issues/11735 and my testing.
   *
   * Nevertheless the issue remains in jsdom.
   * https://github.com/facebook/react/issues/10070#issuecomment-312206989
   *
   *
   * @param {DOMElement} node
   */

  function detectCanStringify(node) {
    var obj = {
      toString: function () {
        return 'foo';
      }
    };
    var attrName = 'reacttest';
    var el = node.ownerDocument.createElement('p');
  ...
  function setValueForProperty(node, name, value, isCustomComponentTag) {
    ...
    if (isCustomComponentTag || propertyInfo === null) {
      if (isAttributeNameSafe(name)) {
        ...
        if (value === null) {
          ...
          node.setAttribute(_attributeName, setAttributeCanStringify ? value : '' + value);
        }
      }
    ...
    if (value === null) {
      ...
      if (setAttributeCanStringify === undefined) {
        setAttributeCanStringify = detectCanStringify(node);
      }
